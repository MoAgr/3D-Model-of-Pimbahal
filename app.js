...
function init() {
  ...
  const sphereSize = 1;
  for (let i = 0; i < 6; i++) {
    lampLightsR[i] = new THREE.PointLight(
      pointLightColor,
      pointLightIntensity,
      pointLightDistance,
      pointLightDecay
    ...
    lampLightHelperR[i] = new THREE.PointLightHelper(
      lampLightsR[i],
      sphereSize
    );
  ...
  tempZ = 10.25;
  for (let i = 0; i < 6; i++) {
    lampLightsL[i] = new THREE.PointLight(
      pointLightColor,
      pointLightIntensity,
      pointLightDistance,
      pointLightDecay
    ...
    lampLightHelperL[i] = new THREE.PointLightHelper(
      lampLightsL[i],
      sphereSize
    );
  ...
  for (let i = 0; i < 13; i++) {
    roofLights[i] = new THREE.PointLight(
      roofLightColor,
      roofLightIntensity,
      roofLightDistance,
      roofLightDecay
  ...
  tempZ = roofLightZ;
  for (let i = 0; i < 12; i++) {
    roofLightsG[i] = new THREE.PointLight(
      roofLightColor,
      roofLightIntensity,
      roofLightDistance,
      roofLightDecay
    ...
    roofLightHelperG[i] = new THREE.PointLightHelper(
      roofLightsG[i],
      sphereSize
    );
